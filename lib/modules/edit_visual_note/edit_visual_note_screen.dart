...
class _EditVisualNotesScreenState extends State<EditVisualNotesScreen> {
    ...
    if (_isValidForm()) {
      ...
      try {
        ...
        if (_visualNote!.id == null) {
          ...
          await visualNotesProvider.updateExistingNote(
              _visualNote!.id!, _visualNote!);
  ...
  void didChangeDependencies() {
    ...
    if (!_isDidChangeDepCalled) {
      ...
      if (id != null) {
        _visualNote = Provider.of<VisualNotesProvider>(context, listen: false)
            .findVisualNoteById(id);
        _initialData = {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(_visualNote!.id == null
                ...
                child: Column(
                  children: [
                    ...
                    TextFormField(
                      ...
                      onSaved: (value) {
                        _visualNote =
                            _visualNote!.copyWith(description: value!.trim());
                      },
                    ),
                    const WhiteSpace(isHorizontal: false),
                    Row(
                    ...
                    DropdownButtonFormField<dynamic>(
                      ...
                      decoration:
                          const InputDecoration(labelText: 'Current Status'),
                      validator: (value) {
                        if (value == null) {
